    ...
    if (node.rel === '' && depth === 0) {
      ...
      return (
        <div>
          ...
          {node.loading && <div style={{ padding: 8, fontSize: 12, color: 'var(--cth-ink-500)' }}>{t('fileTree.loading', 'loading…')}</div>}
      ...
      <div key={node.rel}>
        ...
        >
          ...
          <button
            ...
            title={t('fileTree.copyPathTooltip', 'Copy path to clipboard')}
            style={{
              padding: '0 4px',
              fontSize: 10,
              fontFamily: 'var(--cth-font-ui)',
