...
const TABS: { key: SidebarTab; labelKey: string; label: string; icon: IconName }[] = [
  { key: 'terminal', labelKey: 'sidebarTabs.terminal', label: 'terminal', icon: 'terminal' },
  { key: 'git',      labelKey: 'sidebarTabs.git',      label: 'git',      icon: 'code' },
  { key: 'messages', labelKey: 'sidebarTabs.messages', label: 'messages', icon: 'bell' },
  { key: 'traces',   labelKey: 'sidebarTabs.traces',   label: 'traces',   icon: 'web' }
];
    ...
    <div style={{
      ...
      {TABS.map(tab => {
        ...
        return (
          ...
          >
            <Icon name={tab.icon} /> {t(tab.labelKey, tab.label).toUpperCase()}
          </button>
        );
      })}
    </div>
