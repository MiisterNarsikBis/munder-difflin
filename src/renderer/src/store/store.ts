...
interface State {
  ...
  /** Mirror of the UI display language (set by App on config load + by Settings
   *  on change). Read by useT() (@/i18n) — every translated component re-renders
   *  when this changes since it's a plain store field. */
  language: 'en' | 'fr';
